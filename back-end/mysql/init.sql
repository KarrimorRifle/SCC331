...
CREATE USER IF NOT EXISTS 'account_registration'@'%' IDENTIFIED BY 'reg_password';
...
CREATE USER IF NOT EXISTS 'cookie_manager'@'%' IDENTIFIED BY 'cookie_password';
...
CREATE USER IF NOT EXISTS 'data_processor'@'%' IDENTIFIED BY 'process_password';
...
CREATE USER IF NOT EXISTS 'data_reader'@'%' IDENTIFIED BY 'read_password';
...
CREATE USER IF NOT EXISTS 'data_admin'@'%' IDENTIFIED BY 'admin_password';
